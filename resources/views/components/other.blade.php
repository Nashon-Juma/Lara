...
<body class="h-full">
    <div class="min-h-full">
        <header class="bg-white shadow">
            ...
            <h1 class="text-3xl font-bold tracking-tight text-gray-900"><?=$hed?></h1>
            </div>
    </header>
...
<nav class="bg-gray-800">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/index.php" class="<?= urlIs("/index.php")? 'bg-gray-900 text-white':'text-gray-300' ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
        ...
        <div class="ml-4 flex items-center md:ml-6">
            ...
            <div>
                ...
                <img class="h-8 w-8 rounded-full" src="https://raw.githubusercontent.com/Nashon-Juma/sample-portfolio/main/IMG_9683.JPG" alt="">
                </button>
            </div>
